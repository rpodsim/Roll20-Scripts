(function (shaped) {
	...
	shaped.settings = {
		...
		addInitiativeTokenAbility: false, //change to false if you do not want a macro "Init" on every token
	...
	shaped.statblock = {
		...
		RegisterHandlers: function () {
			...
			if (shaped.settings.rollMonsterHpOnDrop) {
				on('change:graphic:name', function (obj) {
